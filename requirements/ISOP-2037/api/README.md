...
[设计](../design.md) · [问题与决定](../questions.md) · [业务用例](../test-cases.md) · [API数据](data-cases.csv) · [班车报告](../../../reports/qa/batch-20260914-seven/ISOP-2037/results.html)
...
历史结论见 [2026-09-10 FAT 执行记录](../../../docs/history/requirement-records-20260907-11.md#isop-2037-20260910)。定向复测可增加 `--only <组合ID> ...`，每次产生独立证据。

...
[设计](design.md) · [问题与决定](questions.md) · [业务用例](test-cases.md) · [总用例表](cases.csv) · [API数据](api/data-cases.csv) · [班车报告](../../reports/qa/batch-20260914-seven/ISOP-2031/results.html)

设计基线：需求评审/测试准备；实际执行见班车报告。复审日期：2026-09-08（UTC+8）。

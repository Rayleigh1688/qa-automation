...
| AC-02 | 待补预期 | 双条件达标组合 | J附件23955；Q-02 | ISOP-2117-C02 |
| AC-03 | 待补预期 | 领取后与跨周期展示 | J附件23955；Q-02 | ISOP-2117-C03 |
...
| --- | --- | --- | --- |
| CAP-01 / ISOP-2117-C02 | 双条件达标组合；样本与断言见用例 | 未映射；不猜URL/字段 | Q-02 |
| CAP-02 / ISOP-2117-C03 | 领取后与跨周期展示；样本与断言见用例 | 未映射；不猜URL/字段 | Q-02 |

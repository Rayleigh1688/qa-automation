...
| --- | --- | --- | --- | --- |
| AC-01 | 待补预期 | 游戏启动与身份映射（预备） | J标题，评审建议；Q-01 | ISOP-2116-C01 |
| AC-02 | 待补预期 | 投注派彩钱包对账（预备） | J标题，评审建议；Q-01 | ISOP-2116-C02 |
...
| --- | --- | --- | --- |
| CAP-01 / ISOP-2116-C01 | 游戏启动与身份映射（预备）；样本与断言见用例 | 未映射；不猜URL/字段 | Q-01 |
| CAP-02 / ISOP-2116-C02 | 投注派彩钱包对账（预备）；样本与断言见用例 | 未映射；不猜URL/字段 | Q-01 |

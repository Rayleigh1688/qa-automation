...
- 范围：仅能确认对接主题；玩法、钱包、接口与游戏范围均待明确。
- 主来源：[Jira ISOP-2116](https://alibaba-international.atlassian.net/browse/ISOP-2116)。
...
| --- | --- | --- | --- | --- |
| AC-01 | 待补预期 | 游戏启动与身份映射（预备） | J标题，评审建议；Q-01、Q-02 | ISOP-2116-C01 |
| AC-02 | 待补预期 | 投注派彩钱包对账（预备） | J标题，评审建议；Q-01、Q-02 | ISOP-2116-C02 |

具体步骤和断言维护在[test-cases.md](test-cases.md)，问题答复维护在[questions.md](questions.md)，避免重复维护公式。

## 影响与回归选择

仅能确认对接主题；玩法、钱包、接口与游戏范围均待明确。 身份、时间、金额或类型映射必须由独立样本佐证；旧结果不能代替本次验证。查询与计算优先API和只读对账；页面、布局、真实客户端行为由人工UI提供证据。
...
| --- | --- | --- | --- |
| CAP-01 / ISOP-2116-C01 | 游戏启动与身份映射（预备）；样本与断言见用例 | 未映射；不猜URL/字段 | Q-01、Q-02 |
| CAP-02 / ISOP-2116-C02 | 投注派彩钱包对账（预备）；样本与断言见用例 | 未映射；不猜URL/字段 | Q-01、Q-02 |

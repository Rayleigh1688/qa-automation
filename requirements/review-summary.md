...
评审快照：2026-09-07（UTC+8）。本批为需求梳理和测试设计，不是业务验收报告。逐条可分派用例见 [需求索引](README.md)，当前执行状态只维护在各自用例文件。
...
2. [2032 Q-01/02](ISOP-2032/questions.md)：同类型多个游戏规则如何各自封顶和打码，再如何在类型明细展示？活动门槛聚合范围及计提基数是什么？
...
5. [2031 Q-01/02](ISOP-2031/questions.md)：到账动画最终包含哪些事件，一月与一次性的精确定义是什么？

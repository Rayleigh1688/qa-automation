...
- 范围：产品站只准菲律宾网络位置进入大厅；开发工具站境外可用；挡页展示IP与国家/地区。明确排除App runtime geo、GPS、VPN识别。
- 主来源：[Jira ISOP-2094](https://alibaba-international.atlassian.net/browse/ISOP-2094)。
...
| --- | --- | --- | --- | --- |
| AC-01 | 待补预期 | 菲律宾产品站放行 | J验收；Q-01 | ISOP-2094-C01 |
| AC-02 | 待补预期 | 境外产品站拦截 | J验收；Q-01 | ISOP-2094-C02 |
| AC-03 | 待补预期 | 开发工具站境外可用 | J验收；Q-01 | ISOP-2094-C03 |
| AC-04 | 待补预期 | 挡页布局 | J验收；Q-01 | ISOP-2094-C04 |
| AC-05 | 待补预期 | 位置识别异常 | J验收的未定义边界；Q-01、Q-02 | ISOP-2094-C05 |

具体步骤和断言维护在[test-cases.md](test-cases.md)，问题答复维护在[questions.md](questions.md)，避免重复维护公式。

## 影响与回归选择

产品站只准菲律宾网络位置进入大厅；开发工具站境外可用；挡页展示IP与国家/地区。明确排除App runtime geo、GPS、VPN识别。 身份、时间、金额或类型映射必须由独立样本佐证；旧结果不能代替本次验证。查询与计算优先API和只读对账；页面、布局、真实客户端行为由人工UI提供证据。

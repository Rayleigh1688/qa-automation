...
更新：2026-09-11。已按用户授权清理全项目旧结果、扫描归档、临时脚本及重复视图，详见[整理记录](docs/project-cleanup-2026-09-11.md)。旧“全部历史文件保留”约定由此次清理指令替代。未覆盖既有源码修改；没有FAT业务执行、数据库写入、BUG提交、发群或Git提交；2022准备核对新增了只读Jira和数据库元数据/有界样本读取。

## 当前入口

- 提交准备已整理到[提交说明](docs/project-cleanup-2026-09-11.md#提交前整理2026-09-11)：本轮累积源码、需求资产、Telegram流程和已授权归档删除一并审阅，由用户自行提交；未暂存或执行Git提交。新对话先读取本文件和AGENTS.md，再按下面的续接顺序推进。
...
最终提交前核对见[提交说明](docs/project-cleanup-2026-09-11.md#提交前整理2026-09-11)；此前扫描执行与版本衔接的阶段验证见[优化计划](docs/new-requirement-automation-plan.md#扫描执行与版本衔接2026-09-11)。本次整理未运行真实API/UI业务测试、创建BUG或发群，未暂存或提交Git。
